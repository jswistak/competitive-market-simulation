...
Competitive Market Simulation is a LangGraph-based framework for studying how LLM-based agents behave when placed in competitive market environments including continuous double auctions (Smith-style experiments), sealed-bid auctions, English, Dutch, and other mechanisms.
